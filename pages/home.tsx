    ...
    <Layout>
      <div className="w-full px-12 py-6">
        ...
        <div className="mt-7 bg-white shadow-lg rounded-lg w-full">
          ...
          <CallHistoryItem phoneNumber="+65 8123 4567" contactName="John Doe" location="Singapore" date="10/10/2020" time="09:15-09:45am" blocked={false} />
          <CallHistoryItem phoneNumber="+65 8123 4567" contactName="John Doe" location="Singapore" date="10/10/2020" time="09:15-09:45am" blocked={false} />
          <CallHistoryItem phoneNumber="+65 8123 4568" location="Singapore" date="10/10/2020" time="09:15-09:45am" blocked={true} />
          <CallHistoryItem phoneNumber="+65 8123 4568" location="Singapore" date="10/10/2020" time="09:15-09:45am" blocked={true} />
        </div>
      </div>
    </Layout>
