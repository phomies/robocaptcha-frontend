    ...
    <div className="flex flex-col h-screen overflow-y-scroll">
      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 sm:mx-32 mx-10 h-full">
        ...
        <div className="text-sm text-blue-darkBlue font-poppins-regular justify-end xl:self-center mt-6 lg:mt-20 xl:-mt-20">
          <form>
            <div className="text-black hidden lg:block font-poppins-semibold text-2xl mb-4">Sign Up</div>
            ...
            <div className="text-gray-400 sm:my-6 mt-8 mb-4 text-center lg:w-10/12 w-full">or continue with</div>
