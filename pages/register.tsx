    ...
    <div className="flex flex-col h-screen overflow-y-hidden">
      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 sm:mx-32 mx-10 h-full">
        <div className="self-center sm:mt-10 lg:-mt-24 xl:-mt-44">
          <h1 className="font-poppins-semibold text-secondary lg:text-5xl text-2xl lg:mb-6 mb-2 mt-8 md:mt-5 lg:mt-10">Sign up for</h1>
          <h1 className="font-poppins-medium text-secondary lg:text-3xl text-xl lg:mb-12 mb-5">our user platform</h1>
          <h1 className="font-poppins-regular text-sm">If you already have an account, <br /> You can login <a className="font-poppins-semibold text-blue-600 hover:underline" href="/login">here!</a></h1>
        </div>
        ...
        <div className="text-sm text-blue-darkBlue font-poppins-regular justify-end xl:self-center mt-6 lg:mt-20 xl:-mt-20">
          <form>
            ...
            <input className="placeholder:text-blue-darkBlue focus:outline-none px-5 lg:w-10/12 w-full h-12 lg:h-14 rounded-lg bg-blue-lightBlue mb-3"
              placeholder="Name"
            />
            <input className="placeholder:text-blue-darkBlue focus:outline-none px-5 lg:w-10/12 w-full h-12 lg:h-14 rounded-lg bg-blue-lightBlue mb-3"
              placeholder="Email"
            ...
            />
            <input className={`placeholder:text-blue-darkBlue focus:outline-none px-5 lg:w-10/12 w-full h-12 lg:h-14 rounded-lg bg-blue-lightBlue mb-3 ${password !== "" && confirmPassword !== "" && password !== confirmPassword && "border border-red-400"}`}
              placeholder="Password"
              type="password"
              value={password}
              onChange={e => setPassword(e.target.value)}
            />
            <input className={`placeholder:text-blue-darkBlue focus:outline-none px-5 lg:w-10/12 w-full h-12 lg:h-14 rounded-lg bg-blue-lightBlue ${password !== "" && confirmPassword !== "" && password !== confirmPassword && "border border-red-400"}`}
