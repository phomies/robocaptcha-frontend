    ...
    <div className="flex flex-col h-min-screen overflow-y-hidden">
      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 sm:mx-32 mx-10 h-full">
        <div className="self-center sm:mt-10 lg:-mt-24 xl:-mt-44">
          <h1 className="font-poppins-semibold text-secondary lg:text-5xl text-2xl lg:mb-6 mb-2 mt-12">Sign up for</h1>
        ...
        <div className="text-sm text-blue-darkBlue font-poppins-regular justify-end xl:self-center mt-6 lg:mt-10 xl:-mt-44">
          <form>
