  ...
  return (
    <div className="flex flex-col h-screen overflow-y-hidden">
      ...
      <div className="grid grid-cols-3 mx-32 h-full">
        ...
        <div className="justify-end self-center -mt-44">
          <form>
            ...
            <input className="placeholder:text-blue-darkBlue focus:outline-none font-poppins-regular text-sm text-blue-darkBlue px-5 w-10/12 h-14 rounded-lg bg-blue-lightBlue mb-10"
              ...
              type="email"
            />
            <input className="font-poppins-regular placeholder:text-blue-darkBlue focus:outline-none text-sm text-blue-darkBlue px-5 w-10/12 h-14 rounded-lg bg-blue-lightBlue mb-11"
